...
import static com.ezworking.wechatunlock.R.drawable;
import static com.ezworking.wechatunlock.R.layout;
import static com.ezworking.wechatunlock.R.string;
...
public class PullToRefreshView extends LinearLayout {
    ...
    private boolean isShowOnHeaderRefresh = true;
    private boolean isShowOnFooterRefresh = true;
    /**
     * last y
     */
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(layout.refresh_header_item, this, false);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(layout.refresh_footer_item, this, false);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    if (isShowOnHeaderRefresh) headerPrepareToRefresh(deltaY);
                    // setHeaderPadding(-mHeaderViewHeight);
                } else if (mPullState == PULL_UP_STATE) {
                    // PullToRefreshView执行上拉
                    if (isShowOnFooterRefresh) headerPrepareToRefresh(deltaY);
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            mHeaderTextView.setText(string.pull_to_refresh_release_label);
            ...
            mHeaderImageView.startAnimation(mFlipAnimation);
            // mHeaderImageView.
            mHeaderTextView.setText(string.pull_to_refresh_pull_label);
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight) && mFooterState != RELEASE_TO_REFRESH) {
            mFooterTextView.setText(string.pull_to_refresh_footer_release_label);
            ...
            mFooterImageView.clearAnimation();
            mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText(string.pull_to_refresh_footer_pull_label);
    ...
    public void headerRefreshing() {
        ...
        mHeaderTextView.setText(string.pull_to_refresh_refreshing_label);
    ...
    private void footerRefreshing() {
        ...
        mFooterTextView.setText(string.pull_to_refresh_footer_refreshing_label);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(drawable.ic_pulltorefresh_arrow);
        mHeaderTextView.setText(string.pull_to_refresh_pull_label);
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(drawable.ic_pulltorefresh_arrow_up);
        mFooterTextView.setText(string.pull_to_refresh_footer_pull_label);
    ...
    public void setShowOnHeaderRefresh(boolean showOnHeaderRefresh) {
        isShowOnHeaderRefresh = showOnHeaderRefresh;
    }

    public void setShowOnFooterRefresh(boolean showOnFooterRefresh) {
        isShowOnFooterRefresh = showOnFooterRefresh;
    }
